...
async function searchImage(searchText1, page) {
    try {
        ...
        if (lengthHits === 0 || searchText1.trim() === "") throw new Error(`Sorry, there are no images matching your search query. Please try again.`);
        return {
            data: dataResponse.hits,
            totalHits
        };
    } catch (error) {
        (0, _notiflixDefault.default).Notify.failure(error.message);
    }
}
async function addImagesToPage(searchText2) {
    try {
        const { data , totalHits  } = await searchImage(searchText2, currentPage);
        if (currentPage === 1) (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${totalHits} images.`);
        currentPage++;
        addGallery(data);
        lightbox.refresh();
        liteScroll();
        ...
        if (numDisplayedImages >= totalHits) {
            buttonLoadEl.classList.add("hidden");
            (0, _notiflixDefault.default).Notify.success("We're sorry, but you've reached the end of search results.");
        } else buttonLoadEl.classList.remove("hidden");
    } catch (error) {
        (0, _notiflixDefault.default).Notify.failure(error.message);
    }
}
function addGallery(data) {
    let cartImage = data.map(({ webformatURL , tags , likes , views , comments , downloads , largeImageURL ,  })=>{
...
},{"/src/styles.css":"lW6qc","axios":"jo6P5","notiflix":"5z0Oc","Simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lW6qc":[function() {},{}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","buffer":"9TUYB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3u8Tl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("../utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9TUYB":[function(require,module,exports) {
/*!
...
},{"base64-js":"bcZn9","ieee754":"lT4r5"}],"bcZn9":[function(require,module,exports) {
"use strict";
...
},{}],"lT4r5":[function(require,module,exports) {
